...
This is the result of my exploration of printable (specifically alphanumeric) shellcode.
While the code is not optimal in any way and maybe not very clear, this project is just to demonstrate what is possible and push my shellcoding skills. Somebody else might find it interesting too.
